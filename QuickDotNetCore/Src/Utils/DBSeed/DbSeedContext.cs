...
namespace QuickDotNetCore.Src.Utils.DBSeed
{
    public class DbSeedContext
    {
        ...
        /// NetCoreSugarDemo 
        /// </summary>
        public static DbSeedContext Context
        {
            get
            {
                return new DbSeedContext();
            }
        ...
        /// <summary>
        /// 功能描述:构造函数
        /// 作　　者:NetCoreSugarDemo
        /// </summary>
        public DbSeedContext()
        {
        ...
        private DbSeedContext(bool blnIsAutoCloseConnection)
        {
            if (string.IsNullOrEmpty(_connectionString))
                throw new ArgumentNullException("数据库连接字符串为空");
            _db = new SqlSugarClient(new ConnectionConfig()
        ...
        {
            CreateClassFileByDBTalbe(strPath, "NetCoreSugarDemo.Entity");
        }
        /// <summary>
        /// 功能描述:根据数据库表生产实体类
        /// 作　　者:NetCoreSugarDemo
...
")
        ...
        /// <returns>返回值</returns>
        public static DbSeedContext GetDbContext(bool blnIsAutoCloseConnection = true)
        {
            return new DbSeedContext(blnIsAutoCloseConnection);
        }
